...
void heading()
{
    ...
    {
        cout << nameMessage[i];
        fflush(stdout);  //When you want the user to see the output instantly
        delay(50000);    //sren e likha ashe 50000 mili secound late hoy 
    }
...
void mainMenu()
{
    clearScreen();    //screen lesr koar jnno 
...
CompleteProject.cpp
Displaying CompleteProject.cpp.
